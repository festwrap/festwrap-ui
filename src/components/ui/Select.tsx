...
const SELECT_TRIGGER_CLASSES =
  "flex h-10 w-full items-center justify-between rounded-md border-2 border-secondary bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-secondary focus:outline-none focus:ring-2 focus:ring-dark focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-slate-800 dark:bg-slate-950 dark:ring-offset-slate-950 dark:placeholder:text-secondary dark:focus:ring-slate-300"
...
const SELECT_CONTENT_POPPER_CLASSES =
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        position === "popper" && SELECT_CONTENT_POPPER_CLASSES,
        className
      )}
      position={position}
      {...props}
